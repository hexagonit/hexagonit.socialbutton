...
project = u'hexagonit.socialbutton'
...
htmlhelp_basename = 'hexagonit.socialbuttondoc'
...
latex_documents = [(
    'index', 'hexagonit.socialbutton.tex',
    u'hexagonit.socialbutton Documentation', u'Hexagon IT', 'manual'), ]
...
man_pages = [
    (
        'index',
        'todo',
        u'hexagonit.socialbutton Documentation',
        [u'Hexagon IT'],
        1)]
